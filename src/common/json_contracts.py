...
_CONTRACT_PATHS = {
    ...
    "private_health/candidate_patch_set": "schema_refinement/candidate_patch_set.schema.json",
    "private_health/field_frequency": "schema_refinement/field_frequency.schema.json",
    "private_health/patch_stability": "schema_refinement/patch_stability.schema.json",
    "private_health/review_queue": "schema_refinement/review_queue.schema.json",
    "private_health/review_decisions": "schema_refinement/review_decisions.schema.json",
    "private_health/refinement_feedback": "schema_refinement/refinement_feedback.schema.json",
    "schema_refinement/refinement_feedback": "schema_refinement/refinement_feedback.schema.json",
    "schema_refinement/candidate_patch_set": "schema_refinement/candidate_patch_set.schema.json",
    "schema_refinement/field_frequency": "schema_refinement/field_frequency.schema.json",
    "schema_refinement/patch_stability": "schema_refinement/patch_stability.schema.json",
    "schema_refinement/review_queue": "schema_refinement/review_queue.schema.json",
    "schema_refinement/review_decisions": "schema_refinement/review_decisions.schema.json",
